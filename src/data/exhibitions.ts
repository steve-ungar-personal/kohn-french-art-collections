...
export const exhibitRecord: ExhibitRecord[] = [
  ...
  { year: '1970', show: 'PHILYMPIA, London', who: 'Milton', exhibit: 'Famous French Arts', award: 'Sent for exhibition (Kohn’s own inventory; result not yet traced)', frenchArt: true, source: { label: 'Milton Kohn’s handwritten inventory (this collection)', url: '/philympia/' } },
